# Kumano Interior — Hongū & Yunomine  熊野本宮・湯の峰
...
## Things to see & do
- **Kumano Hongū Taisha** — the head shrine of the Kumano Sanzan, its cypress-bark halls reached up a cedar-lined stone stair
...
## What to eat
- **Mehari-zushi** — rice balls wrapped in pickled mustard-leaf, the Kumano pilgrim's lunch.
- **Onsen-cooked eggs & vegetables** — lower them into the Yunomine spring on a string and eat them by the river.
- **Amego & ayu** — grilled river trout and sweetfish from the Totsukawa.
- **Mehari & mountain vegetables (sansai)** — hearty interior fare served at the ryokan.

## Where to stay
Small onsen ryokan and minshuku cluster in the narrow lanes of **Yunomine** and **Kawayu** — exactly the **traditional onsen-ryokan night** the trip is built around. The two anchor inns below both have **their own free parking** (a real bonus in these tight hamlets); rooms are tatami with futons that suit a child well.

| Property | Type | Parking | ¥/night | ≈USD | Notes |
|---|---|---|---|---|---|
| Ryokan Adumaya (Yunomine) | Historic onsen ryokan | **Free on-site parking** | ¥24,000–48,000 | $160–320 | Edo-era inn run for generations, steps from the Tsuboyu bath; its own hot-spring baths and kaiseki dinners; central in the village (lane is tight — confirm approach). |
| Fujiya (Kawayu) | Onsen ryokan | **Free on-site parking** | ¥22,000–42,000 | $145–280 | Riverside rooms over the Ōto River; dig-your-own riverbed bathing on the doorstep — a hit with a child. |
| Yunomine / Kawayu minshuku (e.g. Yoshinoya, Tsuboyu-no-yado) | Family minshuku | On-site / roadside lot (confirm) | ¥12,000–20,000 | $80–135 | Simple, friendly two-night bases with home cooking and onsen; ask where to leave the bikes off the narrow lane. |

_Indicative per room/night for two adults (≈ ¥150 = $1); confirm rates, secure motorcycle parking & passenger/child rules before booking — and reserve a Tsuboyu bath slot ahead._

## Links
- [Kumano Travel / Tanabe-Kumano Tourism Bureau (official)](https://www.tb-kumano.jp/en/)
...
- ![Ōyunohara in autumn](https://upload.wikimedia.org/wikipedia/commons/thumb/5/55/Oyunohara_autumn.jpg/960px-Oyunohara_autumn.jpg) — The great torii framed by autumn colour
