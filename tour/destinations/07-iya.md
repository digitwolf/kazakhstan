...
## About
The Iya Valley is one of Japan's **"three hidden valleys"** — a remote, mist-wrapped gorge in the mountainous heart of Shikoku, so cut off that, by legend, **survivors of the defeated Heike (Taira) clan fled here after losing the Genpei War in 1185** and hid for generations. Gentle paved mountain roads climb above the emerald **Yoshino River**, past terraced hamlets clinging to near-vertical slopes — the kind of deep rural Japan that has all but vanished elsewhere.
...
- **Oboke & Koboke Gorge** — a sightseeing boat threads the jade Yoshino River between sculpted schist cliffs; the **Lapis Oboke** museum at the gorge has a quirky *yōkai* (monster) folklore exhibit kids enjoy **[KID]**
- **Iya-no-Shōben-kozō ("Peeing Boy") statue** — a small bronze boy mid-pee on a cliff edge 200 m above the river, marking where local children once dared each other; a memorable photo stop **[KID]**
- **Nagoro Scarecrow Village** — a depopulated hamlet where one resident has made **hundreds of life-size straw dolls**, now seated at school desks, bus stops and fields — eerie, poignant and oddly delightful for children **[KID]**
- **Oku-Iya double vine bridges & "wild monkey" cart** — deeper in the valley, a "husband-and-wife" pair of vine bridges with a hand-pulled cable cart over the river (note: the deep-valley access roads narrow — keep to the main paved routes with the child)
- **Hinoji-kei viewpoint** — the river bending in a perfect figure-of-"hi" curve far below

## What to eat
- **Iya soba** — short, rough-cut 100% buckwheat noodles grown on the steep slopes; nuttier and more rustic than lowland soba, served hot or cold.
- **Dekomawashi** — skewers of potato, *konnyaku* and *tofu* coated in sweet *miso* and slowly turned over an *irori* hearth fire; the valley's signature snack. **[KID]**
- **Ayu / amego** — sweetfish and red-spotted trout from the clear gorge streams, salt-grilled whole on skewers by the hearth.
- **Soba-gome zōsui** — a buckwheat-grain rice porridge, Heike-era comfort food unique to Iya.

## Where to stay
This is the trip's most atmospheric rural night — choose between a **gorge onsen ryokan** (private cable-car down to riverside baths) and a **restored thatched-roof farmhouse** (machiya-in-the-mountains). All have their own parking, essential out here.

| Property | Type | Parking | ¥/night | ≈USD | Notes |
|---|---|---|---|---|---|
| Hotel Iya Onsen | Gorge onsen ryokan | Free on-site parking | ¥28,000–60,000 | $185–400 | Clings to the cliff; a private **cable-car descends 170 m** to open-air baths by the river — a highlight in itself. Tatami rooms, futons for a child. |
| Hotel Kazurabashi (Shin-Iya Onsen) | Onsen ryokan | Free parking (Yume-Butai deck by the vine bridge) | ¥28,000–60,000 | $185–400 | Hilltop baths reached by a short cable-car, steps from the Kazurabashi; half-board kaiseki. |
| Chiiori / Tōgenkyō-Iya thatched farmhouses | Restored kominka (farmhouse) | On-site / dedicated lot (confirm) | ¥20,000–45,000 | $135–300 | **Alex Kerr's restored 300-year-old thatched farmhouse** (and sister cottages) for a unique whole-house rural night around an open hearth. |
