...
- **Region:** Kansai
- **Itinerary:** Day 2 (start) · Days 21–23 (finish)
- **Stop type:** start
...
- **Nintendo OSAKA + Pokémon Center (Daimaru Umeda 13F)** — Kansai's flagship Nintendo store and a large Pokémon Center sit on the **same floor** of Daimaru next to JR Osaka/Umeda — walk-in, no ticket (~10:00–20:00); Mario/Zelda/Splatoon and Pokémon plush, figures and exclusives. A no-fuss double win for Aslan and Galiya on a Day-22 or Day-24 city afternoon **[KID]**
- **Donguri Republic** — the official **Studio Ghibli** retail shop (Totoro/Ponyo/Kiki goods), in the central Umeda/Namba malls — the easy way to close Galiya's Ghibli thread with a souvenir; Aslan gets a plush out of it too
- **Den Den Town (Nipponbashi) & Super Potato** — Osaka's electronics/otaku district and the trip's best toy/figure shopping: the **Super Potato** retro-game shop (Mario-statue storefront, classic Famicom/N64), floors of **gachapon** capsule toys, and the figure/second-hand shops (Mandarake, Hobby Station) — the most reliable place on the loop to find **Transformers / Takara Tomy robot toys**. Pairs with Kuromon Ichiba next door **[KID]**
- **Kuromon Ichiba** — "Osaka's kitchen": a covered market of fresh seafood, wagyu skewers, fruit and street snacks to eat as you walk — a foodie + kid stop a short walk from Den Den Town **[KID]**
- **Minoh Falls / Minoo Park ([Meiji-no-Mori Mino Quasi-National Park](https://en.wikipedia.org/wiki/Meiji_no_Mori_Mino_Quasi-National_Park))** — the **Day-2 warm-up ride** turnaround, ~30 min north of the Suita rental base: a leafy forest gorge with a 33 m waterfall, wild monkeys and **momiji-tempura** (deep-fried maple leaves) along an easy ~40-min walk — a gentle, kid-friendly first ride on the rental bikes before the demanding Day 3 (easy/optional, weather-dependent) **[KID]**
...
- **Takoyaki** — molten octopus dumplings griddled in dimpled iron pans, brushed with sauce, bonito and mayo; the icon of Osaka street food, eaten standing up. **[KID]**
- **Okonomiyaki** — a savoury cabbage-and-batter "as-you-like-it" pancake cooked on a hotplate at your table; the Osaka (mixed) style differs from Hiroshima's layered version.
- **Kushikatsu** — crisp panko-crumbed skewers (meat, veg, cheese) deep-fried and dunked in a shared sauce — Shinsekai's specialty, with the famous "no double-dipping" rule.
- **Negiyaki & modan-yaki** — thin spring-onion griddle cakes and okonomiyaki folded around yakisoba noodles, local diner staples.
- **Horumon / kushikatsu izakaya** — grilled offal and skewers with beer, the working-city counterpoint to refined Kyoto cuisine.

## Where to stay
Central Osaka is the one stop where a traditional inn with parking *at the door* is genuinely hard — machiya cluster in pedestrian lanes and most city hotels use mechanical garages too low for a tall ADV bike. The practical answer is a **machiya townhouse with a nearby coin lot** for a city night, and a **garage hotel close to the Suita rental base** to bracket the pickup/return. **Flagged:** verify the garage's height/weight limits accept the Africa Twin before booking.
...
- ![Shinsekai and Tsutenkaku Tower](https://upload.wikimedia.org/wikipedia/commons/thumb/2/2b/Shinsekai_and_Tsutenkaku_Tower.jpg/960px-Shinsekai_and_Tsutenkaku_Tower.jpg) — Shinsekai and Tsutenkaku Tower
- ![Osaka Castle Outer Moat and Osaka Business Park, November](https://upload.wikimedia.org/wikipedia/commons/thumb/b/b9/Osaka_Castle_Outer_Moat_and_Osaka_Business_Park%2C_November_2016.jpg/960px-Osaka_Castle_Outer_Moat_and_Osaka_Business_Park%2C_November_2016.jpg) — Osaka Castle Outer Moat and Osaka Business Park, November
- ![Dotonbori Osaka](https://upload.wikimedia.org/wikipedia/commons/thumb/b/b4/Dotonbori_Osaka_1910.jpg/960px-Dotonbori_Osaka_1910.jpg) — Dotonbori Osaka
- ![Osaka Castle August](https://upload.wikimedia.org/wikipedia/commons/thumb/4/4b/Osaka_Castle_August_2024.jpg/960px-Osaka_Castle_August_2024.jpg) — Osaka Castle August
- ![Osaka Castle and Gokuraku-bashi Bridge](https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/Osaka_Castle_and_Gokuraku-bashi_Bridge.jpg/960px-Osaka_Castle_and_Gokuraku-bashi_Bridge.jpg) — Osaka Castle and Gokuraku-bashi Bridge