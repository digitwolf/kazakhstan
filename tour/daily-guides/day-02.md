```json
{
  ...
  "schedule": "no riding · late-morning Nozomi Tokyo → Shin-Osaka, arrive ~midday · lunch ~12:30 near Shin-Osaka · afternoon transfer to the Suita rental base for pickup, paperwork & gear-fit · evening welcome dinner in Dōtonbori / Namba",
  "todo": [
    {"time":"~14:00","name":"Suita rental base (Bike Rental Japan)","what":"Pickup, insurance paperwork, Africa Twin + CB400X walk-around, fit Aslan's child gear and pair intercoms — all on foot, no riding today","map":"https://www.google.com/maps/search/?api=1&query=Bike%20Rental%20Japan%20Suita%20Osaka"},
