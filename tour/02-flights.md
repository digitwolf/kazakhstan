...
The motorcycles are a one-way rental (Tokyo → Osaka), so flights are an **open-jaw**: fly into Tokyo, fly home out of Osaka.

You're starting from Seattle, and the motorcycles are a one-way rental (pick up near Tokyo, drop near Osaka). That means the smartest ticket is an open-jaw / multi-city booking: fly into Tokyo, and fly home out of Osaka — so you never backtrack.

## Outbound: Seattle · SEA → Tokyo · Haneda (HND)

- **When:** Sample: depart Fri 9 Oct 2026 → arrive Sat 10 Oct (next day, crossing the date line)
...
- **When:** Sample: depart ~Fri 30 Oct 2026 (after the bikes are returned)
- **Stops:** 1 stop  ·  **Flight time:** ≈ 13h 30m+ (plus layover)  ·  **From:** $490 one-way (indicative)
- **Airlines:** ANA, United, EVA Air, Korean Air, Delta
- There is no nonstop Osaka–Seattle. Expect one connection via an Asian hub (Tokyo HND/NRT, Taipei TPE, or Seoul ICN). Pick the shortest total travel time, not just the lowest fare.

## Budget
Open-jaw economy realistically lands around $1,100–1,900 per person for October; premium economy/business considerably more. Three travellers (2 adults + child) — kids' fares are usually near-adult on these long-haul routes.
...
- [Expedia — SEA → Tokyo (Haneda)](https://www.expedia.com/lp/flights/sea/hnd/seattle-to-tokyo)
- [Expedia — SEA → Tokyo (Narita)](https://www.expedia.com/lp/flights/sea/nrt/seattle-to-tokyo)
- [Expedia — Osaka (KIX) → SEA](https://www.expedia.com/lp/flights/kix/sea/osaka-to-seattle)
- [Google Flights — open-jaw search](https://www.google.com/travel/flights?q=flights%20Seattle%20to%20Tokyo%20HND%20multi-city%20Osaka%20to%20Seattle)