...
window.DAYS = [
  { d:1, id:"yokohama", miles:0, rest:true, region:"Kanto", title:"Arrival & Bike Pickup", route:"Tokyo / Yokohama",
    ...
    poi:[{ name: "Minato Mirai 21", what: "Harbour skyline & the Cosmo Clock wheel", q: "Minato Mirai 21 Yokohama", slot: "activity" }, { name: "Cup Noodles Museum", what: "Make-your-own-noodles fun for kids", q: "Cup Noodles Museum Yokohama", slot: "activity" }, { name: "Yokohama Chinatown", what: "Welcome dinner — buns & dim sum", q: "Yokohama Chinatown", slot: "lunch" }] },
  { d:2, id:"hakone", miles:60, rest:false, region:"Hakone", title:"Into the Mountains", route:"Yokohama → Hakone",
    ...
    poi:[{ name: "Odawara Castle", what: "Hilltop castle en route", q: "Odawara Castle", slot: "stop" }, { name: "Hakone-Yumoto", what: "Onsen-town coffee break", q: "Hakone-Yumoto Station", slot: "coffee" }, { name: "Lake Ashi & Hakone Shrine", what: "Lakeside torii & pirate boat, soba lunch", q: "Hakone Shrine Lake Ashi", slot: "lunch" }, { name: "Owakudani", what: "Volcanic valley & black eggs", q: "Owakudani", slot: "scenic" }] },
  { d:3, id:"hakone", miles:0, rest:true, region:"Hakone", title:"Hakone Rest Day", route:"Hakone (no transfer)",
    ...
    poi:[{ name: "Hakone Open-Air Museum", what: "Sculpture park with kids' play zones", q: "Hakone Open-Air Museum", slot: "activity" }, { name: "Owakudani Ropeway", what: "Steam vents & black eggs", q: "Owakudani", slot: "activity" }, { name: "Hakone Shrine", what: "Lakeside red torii photo", q: "Hakone Shrine", slot: "scenic" }] },
  { d:4, id:"izu", miles:55, rest:false, region:"Izu", title:"Izu Coastal Run", route:"Hakone → Izu (Shimoda)",
    ...
    poi:[{ name: "Manazuru Cape", what: "Coastal viewpoint", q: "Manazuru Cape", slot: "stop" }, { name: "Jogasaki Coast", what: "Lava cliffs & suspension bridge", q: "Jogasaki Coast", slot: "coffee" }, { name: "Kawazu", what: "Kinmedai seafood lunch", q: "Kawazu Shizuoka", slot: "lunch" }, { name: "Shirahama Beach", what: "Beach & old port town", q: "Shirahama Beach Shimoda", slot: "scenic" }] },
  { d:5, id:"fuji", miles:80, rest:false, region:"Fuji", title:"To the Five Lakes", route:"Izu → Fuji Five Lakes",
    ...
    poi:[{ name: "Mishima Skywalk", what: "Japan's longest suspension footbridge, Fuji view", q: "Mishima Skywalk", slot: "stop" }, { name: "Mishima", what: "Coffee break", q: "Mishima Station", slot: "coffee" }, { name: "Oshino Hakkai", what: "Spring-water village, soba lunch", q: "Oshino Hakkai", slot: "lunch" }, { name: "Lake Kawaguchiko", what: "Lakeside arrival & Fuji views", q: "Lake Kawaguchiko", slot: "scenic" }] },
  { d:6, id:"fuji", miles:25, rest:true, region:"Fuji", title:"Fuji Exploration", route:"Fuji Five Lakes (light riding)",
    ...
    poi:[{ name: "Oishi Park", what: "Flower beds with Fuji behind", q: "Oishi Park Kawaguchiko", slot: "activity" }, { name: "Chureito Pagoda", what: "Iconic pagoda-and-Fuji view", q: "Chureito Pagoda", slot: "activity" }, { name: "Mt Fuji Panoramic Ropeway", what: "Kachi-Kachi cable car viewpoint", q: "Mt Fuji Panoramic Ropeway", slot: "scenic" }] },
  { d:7, id:"nagoya", miles:165, rest:false, region:"Chubu", title:"Westward Transfer", route:"Fuji → Nagoya / Gifu",
    ...
    poi:[{ name: "Lake Suwa", what: "Lakeside leg-stretch & coffee", q: "Lake Suwa", slot: "coffee" }, { name: "Magome-juku", what: "Kiso Valley post-town walk & lunch", q: "Magome-juku", slot: "lunch" }, { name: "Ena Gorge", what: "River-gorge photo stop", q: "Ena Gorge", slot: "scenic" }] },
  { d:8, id:"awaji", miles:145, rest:false, region:"Setouchi", title:"Bridge to the Sea", route:"Nagoya → Awaji Island",
    ...
    poi:[{ name: "Akashi Kaikyo Bridge", what: "World-famous suspension span", q: "Akashi Kaikyo Bridge", slot: "stop" }, { name: "Awaji Service Area", what: "Bridge-view coffee break", q: "Awaji Service Area", slot: "coffee" }, { name: "Awaji onion lunch", what: "Awaji beef & sweet onions", q: "Awaji Island", slot: "lunch" }, { name: "Awaji Hanasajiki", what: "Flower hills over the sea", q: "Awaji Hanasajiki", slot: "scenic" }] },
  { d:9, id:"iya", miles:90, rest:false, region:"Shikoku", title:"Into Iya Valley", route:"Awaji → Iya / Oboke",
    ...
    poi:[{ name: "Naruto Whirlpools", what: "Uzunomichi glass-floor walkway", q: "Uzunomichi Naruto", slot: "stop" }, { name: "Tokushima", what: "Riverside coffee break", q: "Tokushima Station", slot: "coffee" }, { name: "Oboke Gorge", what: "Gorge-side lunch", q: "Oboke Gorge", slot: "lunch" }, { name: "Iya Valley viewpoint", what: "Vine bridge & gorge scenery", q: "Iya Valley", slot: "scenic" }] },
  { d:10, id:"iya", miles:25, rest:true, region:"Shikoku", title:"Iya Rest Day", route:"Iya Valley (no transfer)",
    ...
    poi:[{ name: "Kazurabashi vine bridge", what: "Cross the swaying vine bridge", q: "Iya Kazurabashi", slot: "activity" }, { name: "Oboke Gorge boat", what: "Sightseeing boat on the Yoshino", q: "Oboke Gorge", slot: "activity" }, { name: "Peeing Boy statue", what: "Cliff-edge viewpoint", q: "Iya no Shobenkozo", slot: "scenic" }, { name: "Nagoro Scarecrow Village", what: "Quirky kid stop", q: "Nagoro Scarecrow Village", slot: "scenic" }] },
  { d:11, id:"kochi", miles:70, rest:false, region:"Shikoku", title:"Down to the Coast", route:"Iya → Kochi",
    ...
    poi:[{ name: "Ryugado Cave", what: "Dramatic limestone cave", q: "Ryugado Cave Kochi", slot: "stop" }, { name: "Otoyo michi-no-eki", what: "Roadside coffee break", q: "Michi-no-Eki Otoyo", slot: "coffee" }, { name: "Kochi Castle & Hirome Market", what: "Original keep, market lunch", q: "Kochi Castle", slot: "lunch" }, { name: "Katsurahama", what: "Pacific beach & Ryoma statue", q: "Katsurahama", slot: "scenic" }] },
  { d:12, id:"shimanto", miles:85, rest:false, region:"Shikoku", title:"The Clear River", route:"Kochi → Shimanto River",
    ...
    poi:[{ name: "Susaki", what: "Nabeyaki-ramen coffee stop", q: "Susaki Kochi", slot: "coffee" }, { name: "Niyodo Blue river", what: "Famous translucent-blue river", q: "Niyodo River", slot: "stop" }, { name: "Tatsukushi coast", what: "Seaside lunch", q: "Tatsukushi", slot: "lunch" }, { name: "Sada Chinkabashi", what: "Shimanto 'sinking bridge' photo", q: "Sada Chinkabashi Shimanto", slot: "scenic" }] },
  { d:13, id:"shimanto", miles:20, rest:true, region:"Shikoku", title:"Shimanto Rest Day", route:"Shimanto River (no transfer)",
    ...
    poi:[{ name: "Shimanto River canoe", what: "Canoe or SUP on clear water", q: "Shimanto River canoe", slot: "activity" }, { name: "Sinking-bridge cycling", what: "Easy riverside cycle", q: "Shimanto River cycling", slot: "activity" }, { name: "Cape Ashizuri", what: "Dramatic cape & lighthouse", q: "Cape Ashizuri", slot: "scenic" }] },
  { d:14, id:"dogo", miles:110, rest:false, region:"Shikoku", title:"Castles & Old Towns", route:"Shimanto → Uwajima / Uchiko → Dogo Onsen",
    ...
    poi:[{ name: "Uwajima Castle", what: "Original hilltop keep", q: "Uwajima Castle", slot: "stop" }, { name: "Uwajima taimeshi", what: "Sea-bream-over-rice lunch", q: "Uwajima", slot: "lunch" }, { name: "Uchiko old town", what: "Merchant street & kabuki theatre", q: "Uchiko Yokaichi", slot: "scenic" }, { name: "Garyu Sanso, Ozu", what: "Riverside villa & garden", q: "Garyu Sanso Ozu", slot: "scenic" }] },
  { d:15, id:"dogo", miles:10, rest:true, region:"Shikoku", title:"Dogo Onsen Rest Day", route:"Matsuyama (no transfer)",
    ...
    poi:[{ name: "Matsuyama Castle", what: "Ropeway to a hilltop original castle", q: "Matsuyama Castle Ehime", slot: "activity" }, { name: "Dogo Onsen Honkan", what: "Soak in the historic bathhouse", q: "Dogo Onsen Honkan", slot: "activity" }, { name: "Botchan Ressha", what: "Retro steam-style tram", q: "Botchan Ressha Matsuyama", slot: "scenic" }, { name: "Ishite-ji", what: "Atmospheric pilgrimage temple", q: "Ishiteji Temple Matsuyama", slot: "scenic" }] },
  { d:16, id:"shimanami", miles:95, rest:false, region:"Setouchi", title:"Shimanami Kaido", route:"Matsuyama → Shimanami → Onomichi / Setoda",
    ...
    poi:[{ name: "Imabari Castle", what: "Sea-water-moat castle", q: "Imabari Castle", slot: "stop" }, { name: "Kirosan Observatory", what: "Bridge panorama coffee", q: "Kirosan Observatory Park", slot: "coffee" }, { name: "Oyamazumi Shrine, Omishima", what: "Samurai-armour shrine, lunch", q: "Oyamazumi Shrine", slot: "lunch" }, { name: "Setoda, Ikuchijima", what: "Lemon gelato & Kosanji temple", q: "Setoda", slot: "scenic" }] },
  { d:17, id:"onomichi", miles:25, rest:true, region:"Setouchi", title:"Island Rest Day", route:"Setoda / Onomichi (light riding)",
    ...
    poi:[{ name: "Senkoji Ropeway", what: "Hilltop view over the town & sea", q: "Senkoji Temple Onomichi", slot: "activity" }, { name: "Temple Walk & cat alley", what: "Lanes, cafes & cats", q: "Onomichi Temple Walk", slot: "activity" }, { name: "Kosanji & Hill of Hope", what: "Ornate temple & marble hilltop", q: "Kosanji Temple", slot: "scenic" }] },
  { d:18, id:"kurashiki", miles:90, rest:false, region:"Setouchi", title:"Canal Town or Art Island", route:"Onomichi → Kurashiki / Takamatsu",
    ...
    poi:[{ name: "Fukuyama Castle", what: "Station-side castle", q: "Fukuyama Castle", slot: "stop" }, { name: "Tomonoura", what: "Historic port town coffee", q: "Tomonoura", slot: "coffee" }, { name: "Washuzan Viewpoint", what: "Seto Ohashi bridge panorama, lunch", q: "Washuzan", slot: "lunch" }, { name: "Kurashiki Bikan", what: "Willow-lined canal quarter", q: "Kurashiki Bikan", slot: "scenic" }] },
  { d:19, id:"himeji", miles:70, rest:false, region:"Kansai", title:"The Great Castle", route:"Kurashiki → Himeji / Kobe",
    ...
    poi:[{ name: "Okayama Korakuen", what: "One of Japan's three great gardens", q: "Korakuen Okayama", slot: "stop" }, { name: "Okayama", what: "Coffee break", q: "Okayama Station", slot: "coffee" }, { name: "Himeji Castle & Koko-en", what: "White Heron castle + garden, lunch", q: "Himeji Castle", slot: "lunch" }, { name: "Kobe Harborland", what: "Harbour evening & Kobe beef", q: "Kobe Harborland", slot: "scenic" }] },
  { d:20, id:"osaka", miles:60, rest:false, region:"Kansai", title:"Finish in Kansai", route:"Kobe → Osaka / Kansai",
    ...
    poi:[{ name: "Akashi Kaikyo Bridge", what: "Farewell bridge photo", q: "Akashi Kaikyo Bridge", slot: "stop" }, { name: "Kobe Harborland", what: "Kobe beef lunch & port", q: "Kobe Harborland", slot: "lunch" }, { name: "Dotonbori, Osaka", what: "Bike return, then neon & dinner", q: "Dotonbori Osaka", slot: "scenic" }] },
  { d:21, id:"osaka", miles:0, rest:true, region:"Kansai", title:"Buffer & Departure", route:"Osaka / Kyoto",
    ...
    poi:[{ name: "Fushimi Inari, Kyoto", what: "Thousand vermilion torii gates", q: "Fushimi Inari Taisha", slot: "activity" }, { name: "Osaka Castle", what: "Castle & park", q: "Osaka Castle", slot: "activity" }, { name: "Kaiyukan / Dotonbori", what: "Aquarium or final food street", q: "Osaka Aquarium Kaiyukan", slot: "scenic" }] },
];
